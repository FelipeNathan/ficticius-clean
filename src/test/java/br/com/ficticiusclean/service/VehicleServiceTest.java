...
public class VehicleServiceTest {
	...
	public void calculateConsumption() {
		...
		service.calculateConsumptionByVehicle(fiesta, quatro, BigDecimal.TEN, treze);
		service.calculateConsumptionByVehicle(civic, quatro, BigDecimal.TEN, treze);
		service.calculateConsumptionByVehicle(siena, quatro, BigDecimal.TEN, treze);

		BigDecimalAssert fiestaConsumptionTotal = new BigDecimalAssert(fiesta.getGasConsumptionTotal());
		BigDecimalAssert fiestaPriceConsumptionTotal = new BigDecimalAssert(fiesta.getPriceConsumptionTotal());

		fiestaConsumptionTotal.isEqualTo(new BigDecimal("2.00"));
		fiestaPriceConsumptionTotal.isEqualTo(new BigDecimal("8.00"));

		BigDecimalAssert civicConsumptionTotal = new BigDecimalAssert(civic.getGasConsumptionTotal());
		BigDecimalAssert civicPriceConsumptionTotal = new BigDecimalAssert(civic.getPriceConsumptionTotal());

		civicConsumptionTotal.isEqualTo(new BigDecimal("1.72"));
		civicPriceConsumptionTotal.isEqualTo(new BigDecimal("6.88"));

		BigDecimalAssert sienaConsumptionTotal = new BigDecimalAssert(siena.getGasConsumptionTotal());
		BigDecimalAssert sienaPriceConsumptionTotal = new BigDecimalAssert(siena.getPriceConsumptionTotal());
	...
	public void rankUpToDownVehicleByConsumptionCost() {
		...
		List<VehicleDTO> dtos = service.calculateConsumption(quatro, BigDecimal.TEN, treze);
